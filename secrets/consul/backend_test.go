...
func testBackendConfigAccess(t *testing.T, version string, autoBootstrap bool) {
	...
	cleanup, consulConfig := PrepareTestContainer(t, version, false, !autoBootstrap)
	defer cleanup()
...
func testBackendRenewRevoke(t *testing.T, version string) {
	...
	cleanup, consulConfig := PrepareTestContainer(t, version, false, true)
	defer cleanup()
...
func TestBackend_LocalToken(t *testing.T) {
	...
	cleanup, consulConfig := PrepareTestContainer(t, "latest-supported", false, true)
	defer cleanup()
...
func testBackendEntDiffNamespaceRevocation(t *testing.T) {
	...
	cleanup, consulConfig := PrepareTestContainer(t, "latest-supported", true, true)
	defer cleanup()
